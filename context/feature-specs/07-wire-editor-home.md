...
Fetch owned and shared projects server-side using the existing project data helper and pass both lists to the sidabar.
...
The project ID and Liveblocks roo ID should stay aligned.

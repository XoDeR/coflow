Add a small floating toolbar so selected nodes can change both their background and text color directly on the canvas.
...
4. Selected nodes should visualy reflect their active color pair.
